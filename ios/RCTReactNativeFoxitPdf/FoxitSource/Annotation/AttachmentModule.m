...
-(void)loadModule
{
    ...
    _readFrame.moreToolsBar.attachmentClicked = ^(){
...
-(void)annotItemClicked
{
    ...
    [Utility showAnnotationType:NSLocalizedString(@"kAttachment", nil) type:e_annotFileAttachment pdfViewCtrl:_pdfViewCtrl belowSubview:_readFrame.toolSetBar.contentView];
