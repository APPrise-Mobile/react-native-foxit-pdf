    ...
    if (self) {
        ...
        if (iconType & PROPERTY_ICONTYPE) {
            self.arrayNames =[[NSArray alloc] initWithObjects:NSLocalizedString(@"kIconCheck", nil),
                               ...
                               NSLocalizedString(@"kIconUpLeftArrow", nil), nil];
        ...
        if (iconType & PROPERTY_ATTACHMENT_ICONTYPE) {
            self.arrayNames =[[NSArray alloc] initWithObjects:NSLocalizedString(@"kGraph", nil),
                              NSLocalizedString(@"kPushpin", nil),
                              NSLocalizedString(@"kPaperclip", nil),
                              NSLocalizedString(@"kTag", nil), nil];
